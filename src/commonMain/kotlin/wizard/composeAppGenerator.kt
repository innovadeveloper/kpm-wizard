...
fun ProjectInfo.generateComposeAppFiles(): List<ProjectFile> = buildList {
    ...
    if(info.platforms.size == 1 && info.hasPlatform(ProjectPlatform.Jvm))
        return generateComposeAppFilesOnlyJvm()
...
fun ProjectInfo.generateComposeAppFilesOnlyJvm(): List<ProjectFile> = buildList {
    val info = this@generateComposeAppFilesOnlyJvm
