...
class ColorKtJvm(info: ProjectInfo, isOnlyJvm : Boolean = false) : ProjectFile {
    override val path = if(isOnlyJvm) "${info.moduleName}/src/desktopMain/kotlin/${info.packagePath}/theme/Color.kt" else "${info.moduleName}/src/commonMain/kotlin/${info.packagePath}/theme/Color.kt"
    override val content = """
        package ${info.packageId}.theme
