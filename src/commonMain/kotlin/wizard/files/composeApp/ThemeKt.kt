...
class ThemeKtJvm(info: ProjectInfo, isOnlyJvm : Boolean = false) : ProjectFile {
    //    override val path = "${info.moduleName}/src/commonMain/kotlin/${info.packagePath}/theme/Theme.kt"
    override val path = if(isOnlyJvm) "${info.moduleName}/src/desktopMain/kotlin/${info.packagePath}/theme/Theme.kt" else "${info.moduleName}/src/commonMain/kotlin/${info.packagePath}/theme/Theme.kt"
